...
if __name__ == "__main__":
    ...
    t = Hash(10000)
    pnl = process_time()
    print("Hashtable initialization time: {}s\n".format(pnl-st))
    ...
    with open('words_alpha.txt','r',  encoding="utf-8") as file:
     ...
     #reading each line    
        for line in file:
            t.insert(line)
    jj1 = process_time()
    print("Inserting to hashtable time: {}s\n".format(jj1-jj))
     ...
     #reading each line 
        ...
        for line in file:
            ...
            if(t.search(line) == True):
                ...
                count +=1
    kt = process_time()
    print("Finding common words time: {}s, and total number of common words: {}.\n".format(kt-ppp, count))
    print("Total process time: {}s".format(kt))
